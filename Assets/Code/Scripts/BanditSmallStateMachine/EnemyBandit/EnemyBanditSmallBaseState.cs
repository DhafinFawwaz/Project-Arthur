public abstract class EnemyBanditSmallBaseState
{
    bool _isRootState = false;
    EnemyBanditSmallCore _core;
    EnemyBanditSmallStates _states;
    EnemyBanditSmallBaseState _currentSubState;
    EnemyBanditSmallBaseState _currentSuperState;
    public EnemyBanditSmallBaseState CurrentSubState {get {return _currentSubState;}}
    public EnemyBanditSmallBaseState CurrentSuperState {get {return _currentSuperState;}}
    protected bool IsRootState{get{return _isRootState;} set{_isRootState = value;}}
    protected EnemyBanditSmallCore Core{get{return _core;}}
    protected EnemyBanditSmallStates States{get{return _states;}}
    public EnemyBanditSmallBaseState(EnemyBanditSmallCore contextCore, EnemyBanditSmallStates EnemyBanditSmallStates)
    {
        _core = contextCore;
        _states = EnemyBanditSmallStates;
    }
    ...
    protected void SwitchState(EnemyBanditSmallBaseState newState)
    {
        StateExit();
        newState.StateEnter();
    ...
    protected void SwitchSuperState(EnemyBanditSmallBaseState newState)
    {
    ...
    protected void SetSuperState(EnemyBanditSmallBaseState newSuperState)
    {
        _currentSuperState = newSuperState;
    }
    protected void SetSubState(EnemyBanditSmallBaseState newSubState)
    {
