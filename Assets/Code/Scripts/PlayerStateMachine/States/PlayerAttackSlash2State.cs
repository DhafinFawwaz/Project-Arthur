...
using UnityEngine;
public class PlayerAttackSlash2State : PlayerBaseState
{
    public PlayerAttackSlash2State(PlayerCore contextCore, PlayerStates playerStates) : base (contextCore, playerStates)
    {
        IsRootState = false;
    ...
    public override void StateUpdate()
    {
        ...
        //Execute buffered attack
            ...
            SwitchState(States.AttackSlash1());
